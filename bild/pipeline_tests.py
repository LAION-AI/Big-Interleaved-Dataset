...
def pipeline2(
    warcf="/fsx/home-harrysaini/raw_warc/CC-MAIN-20220807150925-20220807180925-00000.warc.gz",
    wurl="/fsx/home-harrysaini/raw_warc/CC-MAIN-20220807150925-20220807180925-00000.warc.gz",
    config=config,
):
    warc_stats = {
        "warc_img_count": 0,
    ...
    for index_r, record in enumerate(
        ...
        if record.headers["WARC-Type"] == "response" and record.content_length >= 128:
            ...
            if content_type.startswith("text/html"):
                ...
                page_config, bildrecord, imgs, vids, auds, iframedict = parser_bytes(
                    url, html_bytes
                )
